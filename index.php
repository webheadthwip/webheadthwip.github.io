...
<html lang="en">
  ...
  <body>
    <div class="background">
        <li class="dropdown">
            <div class="logo">&#043</div>
            <div class="light">Work</div>
        <ul>
            <li><a href="/uscri.html">USCRI</a></li>
            <li><a href="/terrachanics.html">Terrachanics</a></li>
            <li><a href="/print.html">Print</a></li>
            <li><a href="/trustbalancer.html">Trust Balancer</a></li>
        </ul>
        </li>
        <div class="content">
            <div class="header-content">
                <div class="title light">
                    <div class="header-left">
                        <a href="index.html"><strong>Danny </strong>Tran</a>
                    </div>
                    <div class="header-right">
                        <a href="/aboutme.html">about me</a>
                        <a href="/DannyTranResume2015.pdf">resume</a>
                    </div>
                </div>
                <div class="main-content">
                    <div class="row">
                        <div class="col1 black">
                            <div class="boxline">
                                <a href="uscri.html"><img src="img/USCRI_Logo.svg" alt="USCRI Logo"></a>
                            </div>
                        </div>
                        <div class="col1 terra zoom">
                            <div class="boxline light">
                                 <a href="terrachanics.html">TERRACHANICS</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col1 print zoom">
                            <div class="boxline light">
                                 <a href="print.html">PRINT</a>
                            </div>
                        </div>
                        <div class="col1 trust zoom">
                            <div class="boxline light">
                                 <a href="trustbalancer.html">TRUST BALANCER</a>
                            </div>
                        </div>
                    </div>
...
>>>>>>> 6ed7309f0203399326eb62efe52b1c8d20091515
                </div>
            </div>
            <div class="footer">
                  Site by Danny Tran 2015
            </div>
        </div>  
    </div>
  </body>
